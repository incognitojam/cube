...
class ChunkMeshBuilder {
    ...
    fun build(texture: Texture) = ChunkMesh(vertices.toFloatArray(), textureCoordinates.toFloatArray(),
            ambientLights.toFloatArray(), vegetationColours.toFloatArray(), indices.toIntArray(), texture)
