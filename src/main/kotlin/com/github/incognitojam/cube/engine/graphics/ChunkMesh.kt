...
class ChunkMesh(positions: FloatArray, textureCoordinates: FloatArray, ambientLight: FloatArray,
                vegetationColours: FloatArray, indices: IntArray, private val texture: Texture) {
    ...
    init {
        ...
        var vegetationColourBuffer: FloatBuffer? = null
        ...
        try {
            ...
            // Vegetation colour VBO
            vboId = glGenBuffers()
            vboIdList += vboId
            vegetationColourBuffer = MemoryUtil.memAllocFloat(vegetationColours.size)
            vegetationColourBuffer.put(vegetationColours).flip()
            glBindBuffer(GL_ARRAY_BUFFER, vboId)
            glBufferData(GL_ARRAY_BUFFER, vegetationColourBuffer, GL_STATIC_DRAW)
            ...
            vegetationColourBuffer?.let { MemoryUtil.memFree(it) }
