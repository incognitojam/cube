...
class ItemMesh(positions: FloatArray, textureCoordinates: FloatArray, ambientLight: FloatArray, indices: IntArray) {
    ...
    fun render() {
        ...
        // Bind the items texture
        Items.getTextureMap().bind()
